                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Periodical Info</li>
                        </ol>
                       
                        <div class="card-header"><h3 class="text-center font-weight-light my-4">Periodicals Information</h3></div>
                        
                        <div class="card-body">
                            <div>
                                
                                   <center><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by Periodical ID .." title="Type in a name"> </center>
                            </div>
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                           ...
                                           $st=$con->prepare("select * from Periadical");
                                           $st->execute();
                                           $rs=$st->get_result();
                                           ...
                                           while ($row=$rs->fetch_assoc()){
                                               ...
                                               echo '<td>'.$row["isbn"].'</td>';
                                               echo '<td><a href="modify_periodical?id='.$row["periodicalID"].'" class="btn btn-danger">Modify</a></td>';
                                               echo '<td><a href="removeperiodical?id='.$row["periodicalID"].'" class="btn btn-warning">Remove</a></td>';
