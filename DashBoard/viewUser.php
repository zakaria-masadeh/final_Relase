            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card-header"><h3 class="text-center font-weight-light my-4">Users Information</h3></div><br>
                        
                        <center><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by User ID .." title="Type in a name"> </center>
                        <div class="card-body">
                                        ...
                                        <tbody>
                                           ...
                                           while ($row=$rs->fetch_assoc()){
                                             $pass =sha1( $row["password"]);
                                               ...
                                               echo '<td><a href="modify_user?id='.$row["id"].'" class="btn btn-danger">Modify</a></td>';
                                               echo '<td><a href="removeUser?id='.$row["id"].'" class="btn btn-warning">Remove</a></td>';
