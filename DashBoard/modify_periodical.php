        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    $st = $con->prepare("select * from periadical where periodicalID=?");
                    ...
                    <div class="card-header"><b><h3 class="text-center font-weight-light my-4">Modify Periodical (Periodical ID Number : <?php echo $_GET["id"] ?> )</h3></b></div>
                    <div class="card-body">

                  <form action="" method="post">
                                            <input type="hidden" name="periodicalID" value="<?php echo $row["periodicalID"];?>"/>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="title">Periodical Title</label>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control py-4" id="authorName" type="text"   value="<?php echo  $row["autherName"];?>" name="autherName"  required />
                                            </div>
                                                
                                                
                                           </div><br>
                                           <h4 style="color: red"><b>Important Note : You CAN'T Edit Serial Number or ISBN </b></h4>
                                           <h4 style="color: green">Serial Number for the Periodical :  <?php echo $row["serial"];?></h4>
                                           <h4  style="color: green">ISBN for the Periodical :  <?php echo $row["isbn"];?></h4>
                                           ...
                                           <br>
                                            ...
                                            <center>
                                                 <p style="color: crimson">Select Periodical Section</p>
                                                <select name="section">
...
if (isset($_POST["update"])) {
    ...
    $periodicalID = $_POST["periodicalID"];
    $title = $_POST["title"];
    $pages = $_POST["pages"];
    ...
    $stupdate = $con->prepare("UPDATE periadical SET title='$title',year='$year',pages='$pages',section='$section',publisherName='$publisherName',autherName='$autherName' WHERE periodicalID =?");
    $stupdate->bind_param('i', $periodicalID);
    $stupdate->execute();

    echo '<script>alert("Data Updated");</script>';
    echo ("<script>location.href='viewPeriodical.php'</script>");
}
?>
