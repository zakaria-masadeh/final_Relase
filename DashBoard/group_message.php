        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Send A Group Message .. </h3></div>
                    ...
                    <div class="card-body">
                        ...
                        $st=$con->prepare("INSERT INTO `messenger` (`messageID`, `text`, `id`, `time`) VALUES (NULL, ?,1000, current_timestamp());");
                        $st->bind_param('s', $_POST['txt']);
                        $st->execute();
